...
<head>
  ...
  <link rel="stylesheet" href="/backend/static/dynamic_api.css">
  <style>
...
<div class="qx-shell">
  <header class="qx-topbar">
    ...
    <nav class="qx-nav"><a href="/">Vue</a><a href="/backend">Backend</a><a href="/project-structure">Project Structure</a><a href="/backend/docs">Docs</a></nav>
  </header>
  ...
  <section class="qx-hero">
    <div>
      ...
      <div class="qx-actions"><a class="qx-btn" href="/api/project/archive">Download project archive</a><a class="qx-btn qx-btn-secondary" href="/backend/docs">Open docs</a></div>
    </div>
  </section>
