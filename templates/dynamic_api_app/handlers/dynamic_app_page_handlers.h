...
protected:
    void handlePost(
        ...
        try {
            ...
            payload["next_step"] = "Open /query-builder, /table or /api-playground. All bundled examples are now runnable.";
            buildJsonResponse(res, http::status::ok, boost::json::serialize(payload));
...
inline std::shared_ptr<DynamicAppPageHandler> makeDynamicHomeHandler() {
    return std::make_shared<DynamicAppPageHandler>(
        ...
        R"HTML(<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Qornix Dynamic API</title></head><body><h1>Qornix Dynamic API</h1><p>Landing page template not found.</p><p><a href="/instructions">Open instructions</a></p></body></html>)HTML"
    );
}
...
inline std::shared_ptr<DynamicAppPageHandler> makeSchemaManagerPageHandler() {
    return std::make_shared<DynamicAppPageHandler>(
        ...
        R"HTML(<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Qornix Schema Manager</title></head><body><h1>Qornix Schema Manager</h1><p>Schema Manager template file was not found.</p><p><a href="/">Back to home</a></p></body></html>)HTML"
    );
}
...
inline std::shared_ptr<DynamicAppPageHandler> makeInstructionsPageHandler() {
    return std::make_shared<DynamicAppPageHandler>(
        ...
        R"HTML(<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Qornix Quick Start</title></head><body><h1>Qornix Quick Start</h1><ol><li>Edit schema/app.schema.xml</li><li>Open /schema-manager</li><li>Validate, diff and apply a plan</li><li>Use /query-builder, /table, /api-playground and /docs</li></ol></body></html>)HTML"
    );
}
...
inline std::shared_ptr<DynamicAppPageHandler> makeQueryBuilderPageHandler() {
    return std::make_shared<DynamicAppPageHandler>(
        ...
        R"HTML(<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Qornix Query Builder</title></head><body><h1>Qornix Query Builder</h1><p>Query Builder template file was not found.</p><p><a href="/">Back to home</a></p></body></html>)HTML"
    );
}
...
inline std::shared_ptr<DynamicAppPageHandler> makeTableBrowserPageHandler() {
    return std::make_shared<DynamicAppPageHandler>(
        ...
        R"HTML(<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Qornix Table Browser</title></head><body><h1>Qornix Table Browser</h1><p>Table Browser template file was not found.</p><p><a href="/">Back to home</a></p></body></html>)HTML"
    );
}
...
inline std::shared_ptr<DynamicAppPageHandler> makeRowViewPageHandler() {
    return std::make_shared<DynamicAppPageHandler>(
        ...
        R"HTML(<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Qornix Row View</title></head><body><h1>Qornix Row View</h1><p>Row View template file was not found.</p><p><a href="/table">Back to Table Browser</a></p></body></html>)HTML"
    );
}
...
inline std::shared_ptr<DynamicAppPageHandler> makeApiPlaygroundPageHandler() {
    return std::make_shared<DynamicAppPageHandler>(
        ...
        R"HTML(<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Qornix API Playground</title></head><body><h1>Qornix API Playground</h1><p>API Playground template file was not found.</p><p><a href="/">Back to home</a></p></body></html>)HTML"
    );
}
...
inline std::shared_ptr<DynamicAppPageHandler> makeDocsPageHandler() {
    return std::make_shared<DynamicAppPageHandler>(
        ...
        R"HTML(<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Qornix API Docs</title></head><body><h1>Qornix API Docs</h1><p>Docs template file was not found.</p><p><a href="/openapi.json">Open raw OpenAPI JSON</a></p></body></html>)HTML"
    );
}
inline std::shared_ptr<DynamicAppPageHandler> makeQuerySyntaxPageHandler() {
    return std::make_shared<DynamicAppPageHandler>(
        ...
        R"HTML(<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Qornix Query Syntax</title></head><body><h1>Qornix Dynamic API Query Syntax</h1><p>Query syntax documentation template file was not found.</p><p><a href="/docs">Back to docs</a></p></body></html>)HTML"
    );
}
