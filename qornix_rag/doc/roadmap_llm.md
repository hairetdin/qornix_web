...
6. **Optional integration** — приложение может включать qornix_rag или нет
7. **Universal data sources** — не только файлы на диске, но и QA-пары, текст, markdown, БД
8. **Pluggable architecture** — источники данных расширяются без изменения ядра
